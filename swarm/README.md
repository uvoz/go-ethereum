...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/uvoz/go-ethereum

    go install github.com/uvoz/go-ethereum/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/uvoz/go-ethereum`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/uvoz/go-ethereum
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/uvoz/go-ethereum/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/uvoz/go-ethereum/wiki/Code-Review-Guidelines).
