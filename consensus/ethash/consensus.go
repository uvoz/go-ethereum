...
import (
	...
	"github.com/uvoz/go-ethereum/consensus/misc"
	"github.com/uvoz/go-ethereum/core/state"
	"github.com/uvoz/go-ethereum/core/types"
	"github.com/uvoz/go-ethereum/crypto/sha3"
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/uvoz/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	// https://github.com/uvoz/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/uvoz/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
