...
import (
	...
	"github.com/uvoz/go-ethereum/accounts/abi"
...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		...
		}, { // https://github.com/uvoz/wiki/wiki/Ethereum-Contract-ABI#examples
...
[
	...
	for _, hexdata := range []string{
		...
		// From https://github.com/uvoz/wiki/wiki/Ethereum-Contract-ABI
